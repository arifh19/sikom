<div class="box-body">
    <div class="form-group has-feedback{{ $errors->has('originalitas') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('originalitas', null, ['class' => 'form-control', 'placeholder' => 'Originalitas','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('kebaruan') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('kebaruan', null, ['class' => 'form-control', 'placeholder' => 'Kebaruan','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('manfaat') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('manfaat', null, ['class' => 'form-control', 'placeholder' => 'Manfaat','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('clarity') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('clarity', null, ['class' => 'form-control', 'placeholder' => 'Clarity dalam tulisan','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('kelengkapan_laporan') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('kelengkapan_laporan', null, ['class' => 'form-control', 'placeholder' => 'Kelengkapan Laporan','required']) !!}
      </div>
