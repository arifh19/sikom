<div class="box-body">
    ...
    <div class="col-sm-12">
        {!! Form::text('Aspek_Inovasi', null, ['class' => 'form-control', 'placeholder' => 'Aspek Inovasi']) !!}
    </div> 
    ...
    <div class="col-sm-12">
        {!! Form::text('Dampak_pengguna_masyarakat', null, ['class' => 'form-control', 'placeholder' => 'Dampak penggunaan ke masyarakat dan potensi sustainability']) !!}
    </div> 
    ...
    <div class="col-sm-12">
        {!! Form::text('Desain_dan_usability', null, ['class' => 'form-control', 'placeholder' => 'Desain antarmuka, usability dan UX']) !!}
    </div> 
    ...
    <div class="col-sm-12">
        {!! Form::text('metodologi_pengembangan', null, ['class' => 'form-control', 'placeholder' => 'Metodologi Pengembangan']) !!}
    </div> 
    ...
    <div class="col-sm-12">
        {!! Form::text('Kesesuaian_ide', null, ['class' => 'form-control', 'placeholder' => 'Kesesuaian Ide']) !!}
    </div> 
    ...
    <div class="col-sm-12">
        {!! Form::text('Urgensi_permasalahan', null, ['class' => 'form-control', 'placeholder' => 'Urgensi Permasalahan yang diangkat']) !!}
    </div> 
