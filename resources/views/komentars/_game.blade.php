<div class="box-body">
    <div class="form-group has-feedback{{ $errors->has('Story') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Story', null, ['class' => 'form-control', 'placeholder' => 'Unsur pendidikan dan keterampilan']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Mechanics') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Mechanics', null, ['class' => 'form-control', 'placeholder' => 'Kreativitas dalam pengembangan permainan']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Aesthetics') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Aesthetics', null, ['class' => 'form-control', 'placeholder' => 'Unsur Aesthetics']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Gameplay') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Gameplay', null, ['class' => 'form-control', 'placeholder' => 'Gameplay menarik dan menghibur']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('kesesuaian_proposal') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('kesesuaian_proposal', null, ['class' => 'form-control', 'placeholder' => 'Kesesuaian Fitur/Fungsi dengan Proposal']) !!}
      </div>
