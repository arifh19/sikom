<div class="box-body">
    ...
    <div class="form-group has-feedback{{ $errors->has('Penulisan_proposal') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Penulisan_proposal', null, ['class' => 'form-control', 'placeholder' => 'Penulisan proposal','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Kemungkinan_Proposal_Dapat_Diselesaikan') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Kemungkinan_Proposal_Dapat_Diselesaikan', null, ['class' => 'form-control', 'placeholder' => 'Kemungkinan Proposal dapat diselesaikan','required']) !!}
      </div>
