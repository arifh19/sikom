<div class="box-body">
    <div class="form-group has-feedback{{ $errors->has('Ide_konsep_keaslian') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Ide_konsep_keaslian', null, ['class' => 'form-control', 'placeholder' => 'Ide Konsep Keaslian','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Konsistensi_tema') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Konsistensi_tema', null, ['class' => 'form-control', 'placeholder' => 'Konsistensi Tema','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Kreativitas_dalam_implementasi') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Kreativitas_dalam_implementasi', null, ['class' => 'form-control', 'placeholder' => 'Kreativitas dalam implementasi','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Teknik_modelling_lighting_motion') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Teknik_modelling_lighting_motion', null, ['class' => 'form-control', 'placeholder' => 'Teknik (modelling,lighting,motion)','required']) !!}
      </div>
    ...
    <div class="form-group has-feedback{{ $errors->has('Kekuatan_pesan_artistik') ? ' has-error' : '' }}">
     ...
     <div class="col-sm-12">
        {!! Form::text('Kekuatan_pesan_artistik', null, ['class' => 'form-control', 'placeholder' => 'Kekuatan pesan artistik','required']) !!}
      </div>
