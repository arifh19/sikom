...
class CreateKomentarLaporansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('komentar_laporans', function (Blueprint $table) {
            $table->increments('id');
            //animasi
            $table->text('Ide_konsep_keaslian')->nullable();
            ...
            //Piranti Cerdas
            $table->string('Hasil_kemajuan')->nullable();
            $table->string('Aspek_kreativitas')->nullable();
            $table->string('Laporan_kemajuan_proposal')->nullable();
            $table->string('Potensi_Kegunaan_Hasil_Bagi_Masyarakat')->nullable();
            $table->string('Presentasi_video')->nullable();
            //Smart City
